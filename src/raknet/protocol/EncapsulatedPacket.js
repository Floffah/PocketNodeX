...
class EncapsulatedPacket {
  constructor() {
    _defineProperty(this, "identifierACK", void 0);
  ...
  isReliable() {
    return this.reliability === PacketReliability.RELIABLE || this.reliability === PacketReliability.RELIABLE_ORDERED || this.reliability === PacketReliability.RELIABLE_SEQUENCED || this.reliability === PacketReliability.RELIABLE_WITH_ACK_RECEIPT || this.reliability === PacketReliability.RELIABLE_ORDERED_WITH_ACK_RECEIPT;
  }

  isSequenced() {
    return this.reliability === PacketReliability.UNRELIABLE_SEQUENCED || this.reliability === PacketReliability.RELIABLE_SEQUENCED;
  }

  isOrdered() {
    return this.reliability === PacketReliability.RELIABLE_ORDERED || this.reliability === PacketReliability.RELIABLE_ORDERED_WITH_ACK_RECEIPT;
  }

  isSequencedOrOrdered() {
    return this.reliability === PacketReliability.UNRELIABLE_SEQUENCED || this.reliability === PacketReliability.RELIABLE_ORDERED || this.reliability === PacketReliability.RELIABLE_SEQUENCED || this.reliability === PacketReliability.RELIABLE_ORDERED_WITH_ACK_RECEIPT;
  }
