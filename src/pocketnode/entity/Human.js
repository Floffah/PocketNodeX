...
class Human extends Entity {
   ...
   */
  constructor(server) {
    super(server); // if (this._skin === null) {
  ...
  __call(method, args) {} //console.log(`'${method}()' is missing!`);
  ...
  sendSkin(targets = null) {
    ...
    pk.skin = this._skin;
    this.server.broadcastPackets(pk, targets); // this.server.broadcastPackets(pk, targets || this.hasSpawned)
  }

  jump() {
    super.jump();

    if (this.isSprinting()) {//TODO
    }
  }

  getFood() {//TODO: attribute map
  }
