...
const PluginManifest = require("./PluginManifest"); // const Listener = require("../event/Listener");
...
class PluginManager {
  ...
  initVars() {
    ...
    this.loaders = new Map(); // this.eventManager = new EventManager();
  }
  ...
  registerListener(listener, plugin) {} // CheckTypes([Listener, listener], [Plugin, plugin]);
  ...
  callEvent(event) {// return this.eventManager.callEvent(event.getName(), event);
  }
