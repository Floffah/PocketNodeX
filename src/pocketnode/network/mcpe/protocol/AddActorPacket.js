...
class AddActorPacket extends DataPacket {
  constructor(...args) {
    ...
    _defineProperty(this, "entityUniqueId", null);

    _defineProperty(this, "entityRuntimeId", void 0);

    _defineProperty(this, "type", void 0);

    _defineProperty(this, "position", void 0);

    _defineProperty(this, "motion", void 0);

    _defineProperty(this, "pitch", 0.0);

    _defineProperty(this, "yaw", 0.0);

    _defineProperty(this, "headYaw", 0.0);
  ...
  _encodePayload() {
    ...
    this.writeEntityRuntimeId(this.entityRuntimeId); // let find = AddActorPacket.LEGACY_ID_MAP_BC.find(id => id === this.type);
    // if (!find) {
